# Shirley (PO) Memory Index

- [ReWinds milestone strategy](project_milestones.md) — Two-phase: Milestone A = BYOK free app, Milestone B = subscription product; Stripe not allowed for iOS IAP
...
- [Display-layer unit conversion](feedback_display_layer_conversion.md) — API always stores metric (km/h); convert at display time only via FormatUtils pure function + AppSettingsStore persistence; hide dead settings rows
